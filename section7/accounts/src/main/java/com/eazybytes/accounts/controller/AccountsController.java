...
public class AccountsController {
     ...
     *
     * @return the build version information as a string.
     */
    @Operation(
            summary = "Get Build Version REST API",
            description = "REST API to get the build version information"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "REST API to get the Java version information"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
